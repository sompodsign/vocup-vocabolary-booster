        ...
        <div className="h-full min-h-screen bg-slate-300">
            ...
            <div class="d-flex .justify-content-evenly">
                <div>
                    ...
                    {/* <button disabled={!inputValue.length && 'disabled'}  onClick={handleSearch} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button> */}

                <button onClick={handleSearch} disabled={!inputValue.length && 'disabled'} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
                    {loading &&
